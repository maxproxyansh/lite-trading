...
class Portfolio(Base):
    ...
    cash_balance = Column(Float, nullable=False, default=500000.0)
    blocked_margin = Column(Float, nullable=False, default=0.0)
    blocked_premium = Column(Float, nullable=False, default=0.0)
...
class Order(Base, BaseModelMixin):
    ...
    premium_required = Column(Float, nullable=False, default=0.0)
...
class Position(Base, BaseModelMixin):
    ...
    average_open_price = Column(Float, nullable=False, default=0.0)
